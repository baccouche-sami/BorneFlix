...
// Import des images
import installationSec from "@/assets/images/solutions/s11.png";
import infrastructureImage from "@/assets/images/solutions/s3.png";
import individualImage from "@/assets/images/solutions/s2.jpg";
import anticipationImage from "@/assets/images/solutions/s4.jpg";
...
import installationImage from "@/assets/images/solutions/s13.png";
import rechargeImage1 from "@/assets/images/solutions/s1.jpg";
import rechargeImage2 from "@/assets/images/solutions/s15.png";
...
import capture1 from "@/assets/images/solutions/s10.png";
import capture2 from "@/assets/images/solutions/s11.png";
import capture3 from "@/assets/images/solutions/s12.jpg";
import capture4 from "@/assets/images/reelles/images-13.png";
// Images de bornes supplémentaires
import recharge from "@/assets/images/solutions/s14.jpg";
import hero2Image from "@/assets/images/hero/hero2.jpg";
import heroRechargeImage1 from "@/assets/images/solutions/s5.jpg";
import heroRechargeImage2 from "@/assets/images/solutions/s6.jpg";
import heroRechargeImage3 from "@/assets/images/solutions/s7.png";
import sectionImage1 from "@/assets/images/solutions/s8.jpg";
import sectionImage13 from "@/assets/images/solutions/s9.jpg";
import sectionImage4 from "@/assets/images/solutions/s1.jpg";
  ...
  const solutions = [
    {
      ...
      description:
        "Solution rapide et économique avec la prise renforcée Green'up de Legrand. Installation simple en 1h, idéale pour commencer la recharge électrique.",
    ...
    },
    {
      ...
      description:
        "Installez votre borne de recharge personnelle à domicile. Solution simple, rapide et économique pour recharger votre véhicule électrique.",
    ...
    },
    {
      ...
      description:
        "Équipez l'ensemble de votre parking avec une infrastructure commune connectée. Chaque résident dispose d'un point de charge individuel optimisé.",
    ...
    },
    {
      ...
      description:
        "Équipez votre entreprise avec des bornes de recharge intelligentes pour vos employés et clients. Gestion centralisée et optimisation des coûts.",
  ...
  const advantages = [
    {
      ...
      description:
        "Installation en 24h pour les copropriétés, 2h pour les particuliers. Une équipe d'experts certifiés à votre service.",
      metric: "2-24h",
      color: "secondary",
    },
    {
      ...
      description:
        "Bornes connectées avec gestion intelligente de l'énergie. Optimisez votre consommation et économisez jusqu'à 50%.",
      metric: "Jusqu'à 50%",
      color: "primary",
    },
    {
      ...
      description:
        "Maintenance incluse, garantie 2 ans et support technique 24/7. Votre tranquillité d'esprit garantie.",
      metric: "2 ans",
      color: "yellow",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Notre système intelligent régule la recharge aux moments où les tarifs du réseau sont les plus bas. Économies garanties grâce aux tarifs dynamiques et à l'optimisation de l'énergie solaire.",
      image: recharge,
      borderColor: "#8dc63f",
    },
    {
      ...
      description:
        "Notre système intelligent supervise votre consommation et équilibre la charge. Plus de risque de disjonction même si vous cuisinez ou repassez en même temps.",
      image: installationSec,
      borderColor: "#003566",
    },
    {
      ...
      description:
        "L'application BorneFlix vous donne le contrôle sur votre recharge intelligente. Suivez vos coûts en temps réel et optimisez votre consommation d'énergie.",
    ...
    <>
      <SEOHead
        ...
        structuredData={{
          ...
          description:
            "Solutions complètes de bornes de recharge IRVE pour copropriétés, particuliers et entreprises",
          provider: {
            "@type": "Organization",
            name: "BorneFlix",
          },
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description:
                    "Infrastructure collective intelligente pour copropriétés",
                  price: "1299€",
                },
              },
              {
                ...
                itemOffered: {
                  ...
                  description:
                    "Borne de recharge individuelle pour particuliers",
                  price: "699€",
                },
              },
              {
        ...
        >
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              >
                <span className="font-semibold text-[#003566]">BorneFlix</span>{" "}
                propose des solutions IRVE intelligentes pour{" "}
                <span className="font-semibold text-[#8dc63f] bg-[#8dc63f]/10 px-2 py-1 rounded-lg">
                  particuliers
                </span>
                ,{" "}
                <span className="font-semibold text-[#8dc63f] bg-[#8dc63f]/10 px-2 py-1 rounded-lg">
                ...
                . <br className="hidden md:block" />
                <span className="font-bold text-[#8dc63f]">Dès 299€</span> pour
                la prise Green'up Legrand ou{" "}
                <span className="font-bold text-[#8dc63f]">699€</span> pour une
                solution complète.
              </motion.p>
                ...
                >
                  <Card className="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl border-0 hover:shadow-2xl transition-all duration-500 h-full relative">
                    ...
                    <div className="h-56 lg:h-64 overflow-hidden relative">
                      ...
                      <div
                        className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm px-3 py-2 rounded-full text-xs font-semibold shadow-lg"
            ...
            >
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Découvrez notre gamme complète de bornes de recharge
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 mb-12">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4">
                      <h3 className="text-xl font-bold text-[#003566] mb-2">
                        Borne murale intelligente
                      </h3>
                      <p className="text-gray-600 text-sm mb-3">
                        Borne de recharge connectée avec gestion intelligente de
                        l'énergie
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-[#8dc63f] font-bold text-lg">
                          Type : Murale
                        </span>
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4">
                      ...
                      <p className="text-gray-600 text-sm mb-3">
                        Solution idéale pour les parkings extérieurs et espaces
                        publics
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-[#8dc63f] font-bold text-lg">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4">
                      ...
                      <p className="text-gray-600 text-sm mb-3">
                        Design compact parfait pour les garages et espaces
                        restreints
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-[#8dc63f] font-bold text-lg">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4">
                      ...
                      <p className="text-gray-600 text-sm mb-3">
                        Infrastructure collective avec bornes individuelles
                        connectées
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-[#8dc63f] font-bold text-lg">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4">
                      <h3 className="text-xl font-bold text-[#003566] mb-2">
                        Borne professionnelle
                      </h3>
                      <p className="text-gray-600 text-sm mb-3">
                        Solution entreprise avec gestion centralisée et
                        facturation
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-[#8dc63f] font-bold text-lg">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4">
                      ...
                      <p className="text-gray-600 text-sm mb-3">
                        Solution rapide et économique avec prise renforcée
                        Legrand
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-[#8dc63f] font-bold text-lg">
              ...
              <div className="text-center">
                <div className="bg-gradient-to-r from-[#003566]/5 to-[#8dc63f]/5 rounded-2xl p-8 border border-[#003566]/10">
                  <h3 className="text-2xl font-bold mb-4 text-[#003566]">
                    Trouvez votre borne idéale
                  </h3>
                  <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                    Nos experts vous aident à choisir la solution parfaite selon
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="tel:0123456789">
                      <Button
                        variant="outline"
                        className="border-2 border-[#003566] text-[#003566] hover:bg-[#003566] hover:text-white font-semibold py-4 px-8 rounded-full transition-all duration-300"
                      >
            ...
            >
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#003566]">
                  Nos solutions{" "}
                  <span className="text-[#8dc63f]">en action</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Découvrez nos installations réelles et nos réalisations sur le
                  terrain
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <h3 className="text-white font-bold text-lg mb-1">
                      Installation copropriété
                    </h3>
                    <p className="text-white/80 text-sm">
                      Infrastructure collective intelligente
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    ...
                    <p className="text-white/80 text-sm">
                      Solution personnalisée à domicile
                    </p>
                  </div>
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                  <div className="p-8 lg:p-12 flex flex-col justify-center">
                    ...
                    <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                      Notre équipe d'experts certifiés assure une installation
                      rapide et sécurisée de vos bornes de recharge. Du
                      diagnostic initial à la mise en service, nous vous
                    ...
                    <div className="space-y-4 mb-8">
                      <div className="flex items-start">
                        ...
                        <div>
                          <h4 className="font-bold text-[#003566] mb-1">
                            Diagnostic et devis
                          </h4>
                          <p className="text-gray-600 text-sm">
                            Évaluation technique et devis personnalisé en 24h
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            Installation en 2-24h selon le type de solution
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            Tests et formation à l'utilisation
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      <a
                        href="tel:0123456789"
                        className="inline-flex items-center text-[#003566] hover:text-[#8dc63f] transition-colors"
                      >
                        <i className="fas fa-phone-alt mr-2"></i>
            ...
            <div className="mb-20">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#003566]">
                  Fonctionnalités{" "}
                  <span className="text-[#8dc63f]">intelligentes</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  ...
                  >
                    ...
                    <div className="flex items-center mb-4">
                      <div
                        ...
                        style={{ backgroundColor: `${feature.borderColor}20` }}
                      >
                        <i
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-primary/5 to-secondary/5 rounded-2xl p-8 border border-primary/10">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Rejoignez les milliers de clients satisfaits qui ont choisi
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <a href="tel:0123456789">
                    <Button
                      variant="outline"
                      className="border-2 border-primary text-primary hover:bg-primary hover:text-white font-semibold py-4 px-8 rounded-full transition-all duration-300"
                    >
                      <i className="fas fa-phone-alt mr-2"></i>
                      Appeler un expert
                    </Button>

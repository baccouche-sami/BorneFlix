    ...
    <section id="avantages" className="py-16 bg-gray-100">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-white p-6 rounded-lg shadow-md">
            <CardContent className="p-0">
              ...
              <p>Installateurs qualifiés IRVE et techniciens formés aux spécificités des copropriétés.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white p-6 rounded-lg shadow-md">
            <CardContent className="p-0">
              ...
              <p>Assistance pour l'obtention des aides ADVENIR et optimisation du plan de financement.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white p-6 rounded-lg shadow-md">
            <CardContent className="p-0">
              ...
              <p>Respect de toutes les normes en vigueur et accompagnement pour les démarches en assemblée générale.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white p-6 rounded-lg shadow-md">
            <CardContent className="p-0">
              ...
              <p>Support technique 7j/7 et suivi personnalisé pour les gestionnaires de copropriété.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mt-12 text-center">
          <a href="#devis">
            <Button className="bg-secondary hover:bg-green-600 text-white font-medium py-3 px-8 rounded-full">
